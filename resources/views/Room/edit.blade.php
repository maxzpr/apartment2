...
<form action="{{action('RoomsController@update',$id)}}" method="post"  data-role="validator" action="javascript:">
        ...
        <div class="form-group">
            ...
            <input type="text" data-validate="required minlength=2" 
        ...
        <div class="form-group">
            <label>ประเภท</label>
            <select name="type" id="type" data-validate="required">
                <option value="พัดลม" {{$room['type']=="พัดลม"?'selected':''}}>พัดลม</option>
                <option value="แอร์"{{$room['type']=="พัดลม"?'selected':''}}>แอร์</option>
            </select>
            <span class="invalid_feedback">
                กรุณาเลือกประเภท
            </span>
        ...
        <div class="form-group">
            <label>
                <input type="checkbox" name="is_empty"  data-role="checkbox" {{$room['is_empty']=="1"?'checked':''}}/>
                ห้องว่าง
            </label>
        </div>
